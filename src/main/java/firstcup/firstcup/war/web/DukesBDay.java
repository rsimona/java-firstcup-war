 ...
 */
package firstcup.firstcup.war.web;

import firstcup.firstcup.war.ejb.DukesBirthdayBean;
...
public class DukesBDay implements Serializable {
    ...
    private static final Logger logger = Logger.getLogger("firstcup.firstcup.war.web.DukesBDay");
